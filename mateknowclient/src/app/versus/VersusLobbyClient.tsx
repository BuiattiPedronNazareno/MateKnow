  ...
  const handleBuscarPartida = async () => {
    ...
    try {
      ...
      versusService.onError((data) => {
        ...
        if (
          data.message.includes("no hay suficientes") ||
          data.message.includes("Se necesitan mínimo")
        ) {
          setTimeout(() => {
            router.push(`/clases/${claseId}`);
          }, 5000);
      ...
      <Container maxWidth="md">
        ...
        {error && (
          <Alert
            ...
            onClose={
              status === "error" && error.includes("no tiene suficientes")
                ? undefined
                : () => setError("")
            }
          >
        ...
        >
          ...
          <Box
            sx={{
              background:
                "linear-gradient(90deg, #8B4513 0%, #D2691E 50%, #CD853F 100%)",
              py: 3,
              px: 4,
              textAlign: "center",
            }}
          ...
          <CardContent sx={{ p: 4 }}>
              ...
              <Box sx={{ textAlign: "center", py: 4 }}>
                ...
                >
                  ...
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    <Typography
                      variant="h3"
                      sx={{ color: "#D2691E", fontWeight: 900 }}
                    >
                      VS
                    </Typography>
                  </Box>
                ...
                <Button
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      background:
                        "linear-gradient(135deg, #654321 0%, #A0522D 100%)",
                ...
                >
                  ...
                  <Box sx={{ textAlign: "left", color: "#5D4037" }}>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fase 1 - Selección:</strong> Elegí 5 preguntas
                      para que responda tu rival. Si te colgas y no elegís lo
                      hacemos por vos.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fase 2 - Respuestas:</strong> Respondé las 5
                      preguntas que te eligieron, entre más rapido mejor.
                    </Typography>
              ...
              <Box sx={{ textAlign: "center", py: 4 }}>
                ...
                >
                  ...
                  >
                    <Typography
                      variant="h4"
                      sx={{ color: "#3E2723", fontWeight: 700 }}
                    >
                ...
                <Typography
                  variant="h5"
                  sx={{ color: "#3E2723", mb: 1, fontWeight: 600 }}
                >
                  Buscando oponente...
                </Typography>
                ...
                <LinearProgress
                  sx={{
                    ...
                    "& .MuiLinearProgress-bar": {
                      background:
                        "linear-gradient(90deg, #8B4513, #D2691E, #CD853F)",
                      borderRadius: 3,
                    },
                  }}
                />
            ...
            {status === "found" && (
              <Box sx={{ textAlign: "center", py: 6 }}>
                ...
                <Typography
                  variant="h4"
                  sx={{ color: "#3E2723", fontWeight: 700, mb: 1 }}
                >
                  ¡Oponente encontrado!
                </Typography>
        ...
        <Box sx={{ display: "flex", gap: 2, mt: 4, justifyContent: "center" }}>
          ...
          >
            ...
            <Typography variant="h5" sx={{ color: "#3E2723", fontWeight: 700 }}>
              -
            </Typography>
